...
const corsOptions = {
  origin: ["http://localhost:3000"], // Allow requests from example1.com and example2.com
...
connection.createCollection(`User`);

connection.createCollection(`UserFitness`);
 
connection.createCollection(`UserNutrition`);
